...
inline void requestRoutesChassisLogServiceCollection(App& app)
{
    ...
    BMCWEB_ROUTE(app, "/redfish/v1/Chassis/<str>/LogServices/")
        ...
        checkValidChassisId(
            ...
            asyncResp->res.jsonValue["Members"] = std::move(logServiceArrays);
            });
        });
}
...
inline void requestRoutesChassisLogEntryCollection(App& app)
{
    BMCWEB_ROUTE(app,
        ...
        checkValidChassisId(
            asyncResp, chassisId,
            std::bind_front(
                getChassisLogEntryCollection, asyncResp, chassisId,
                delegatedQuery.skip.value_or(0),
    ...
    BMCWEB_ROUTE(
        ...
        checkValidChassisId(
            ...
            crow::connections::systemBus->async_method_call(
                ...
                "/xyz/openbmc_project/object_mapper",
                "xyz.openbmc_project.ObjectMapper", "GetSubTreePaths",
                "/xyz/openbmc_project/logging/chassis/" + chassisId, 0,
